...
from resume.resume_matcher.dataextractor.KeyTerm_Extractor import KeytermExtractor
from resume.resume_matcher.dataextractor.Text_Cleaner import TextCleaner, CountFrequency
from resume.resume_matcher.scripts.utils import generate_unique_id
...
class ParseDocumentToJson:
    def __init__(self, doc: str, doc_type: str):
        ...
        self.entities = DataExtractor(self.doc_data).extract_entities_updated()
