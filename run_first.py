...
from resume.scripts.JobDescriptionProcessor import JobDescriptionProcessor
from resume.scripts.ResumeProcessor import ResumeProcessor
from resume.scripts.utils.ReadFiles import get_filenames_from_dir
from resume.scripts.utils.logger import init_logging_config
...
try:
    ...
    #remove_old_files(root+PROCESSED_RESUMES_PATH)#REVERT
...
try:
    # Check if there are resumes present or not.
    # If present then parse it.
    #remove_old_files(PROCESSED_JOB_DESCRIPTIONS_PATH)#REVERT
